...
$GCC_14_EXECUTABLE $GCC_FLAGS -O2 ZeroOneSolver.cpp -o bin/GCC-14-O2
$GCC_14_EXECUTABLE $GCC_FLAGS -O2 -flto ZeroOneSolver.cpp -o bin/GCC-14-O2-LTO
$GCC_14_EXECUTABLE $GCC_FLAGS -O2 -fwhole-program ZeroOneSolver.cpp -o bin/GCC-14-O2-WP
$GCC_14_EXECUTABLE $GCC_FLAGS -O2 -flto -fwhole-program ZeroOneSolver.cpp -o bin/GCC-14-O2-LTO-WP
$GCC_14_EXECUTABLE $GCC_FLAGS -O2 -march=native ZeroOneSolver.cpp -o bin/GCC-14-O2-NATIVE
$GCC_14_EXECUTABLE $GCC_FLAGS -O2 -march=native -flto ZeroOneSolver.cpp -o bin/GCC-14-O2-NATIVE-LTO
$GCC_14_EXECUTABLE $GCC_FLAGS -O2 -march=native -fwhole-program ZeroOneSolver.cpp -o bin/GCC-14-O2-NATIVE-WP
$GCC_14_EXECUTABLE $GCC_FLAGS -O2 -march=native -flto -fwhole-program ZeroOneSolver.cpp -o bin/GCC-14-O2-NATIVE-LTO-WP
$GCC_14_EXECUTABLE $GCC_FLAGS -O3 ZeroOneSolver.cpp -o bin/GCC-14-O3
$GCC_14_EXECUTABLE $GCC_FLAGS -O3 -flto ZeroOneSolver.cpp -o bin/GCC-14-O3-LTO
$GCC_14_EXECUTABLE $GCC_FLAGS -O3 -fwhole-program ZeroOneSolver.cpp -o bin/GCC-14-O3-WP
$GCC_14_EXECUTABLE $GCC_FLAGS -O3 -flto -fwhole-program ZeroOneSolver.cpp -o bin/GCC-14-O3-LTO-WP
$GCC_14_EXECUTABLE $GCC_FLAGS -O3 -march=native ZeroOneSolver.cpp -o bin/GCC-14-O3-NATIVE
$GCC_14_EXECUTABLE $GCC_FLAGS -O3 -march=native -flto ZeroOneSolver.cpp -o bin/GCC-14-O3-NATIVE-LTO
$GCC_14_EXECUTABLE $GCC_FLAGS -O3 -march=native -fwhole-program ZeroOneSolver.cpp -o bin/GCC-14-O3-NATIVE-WP
$GCC_14_EXECUTABLE $GCC_FLAGS -O3 -march=native -flto -fwhole-program ZeroOneSolver.cpp -o bin/GCC-14-O3-NATIVE-LTO-WP
...
hyperfine --warmup 2 --runs 5 \
    ...
    "bin/GCC-14-O2" "bin/GCC-14-O2-LTO" "bin/GCC-14-O2-WP" "bin/GCC-14-O2-LTO-WP" \
    "bin/GCC-14-O2-NATIVE" "bin/GCC-14-O2-NATIVE-LTO" "bin/GCC-14-O2-NATIVE-WP" "bin/GCC-14-O2-NATIVE-LTO-WP" \
    "bin/GCC-14-O3" "bin/GCC-14-O3-LTO" "bin/GCC-14-O3-WP" "bin/GCC-14-O3-LTO-WP" \
    "bin/GCC-14-O3-NATIVE" "bin/GCC-14-O3-NATIVE-LTO" "bin/GCC-14-O3-NATIVE-WP" "bin/GCC-14-O3-NATIVE-LTO-WP" \
